...
const HeroTentangKami = () => {
  return (
    <section className="w-full min-h-screen">
      <div className="container-custom mt-40 px-4 lg:px-0 flex flex-col gap-4 justify-center items-center text-center">
      ...
      <div className="container-custom my-24 px-4 lg:px-0">
